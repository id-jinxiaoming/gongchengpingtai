...
<form class="form-horizontal m-t" id="myForm" action="${basePath}/image/text/edit" method="post" enctype="multipart/form-data">
                    ...
                    <div class="ibox-title">
                        <div class="builder-tabs builder-form-tabs">
                            <ul class="nav nav-tabs">
                                <li class="active"><a href="${basePath}/image/text/edit">编辑</a></li>
                            </ul>
                        </div>
                    </div>
                    <div class="ibox-content" style="border:none;">
                                ...
                                <div class="layui-tab-item layui-show">
                                    ...
                                    <div class="ibox-content">
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-3">
                                                <select class="form-control m-b" name="pcId">
                                                    <option value="0">无位置</option>
                                                    <#list brand as item>
                                                        <option value="${item.id}"
                                                            <#if item.id==imageText.pcId>
                                                                selected="selected"
                                                            </#if>
                                                        >${item.name}</option>
                                                    </#list>
                                        ...
                                        <div class="ibox-content">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-9" >
                                                    <div >
                                                        <!--用来存放item-->
                                                        <img id="imgPhoto1" src="${imageText.images}" width="100%" height="100%"/>
                                                        <input id="photo1"  value="${imageText.images}"  type="hidden" name="images" value=""/>
                        ...
                        <div class="form-group">
                            <div class="col-sm-8 col-sm-offset-3">
                                <input type="hidden" name="id" value=" ${imageText.id}"/>
                                <button class="btn btn-primary" type="submit">提交</button>
                                <a  class="btn btn-danger" type="button"  href="${basePath}/image/text/list"><i class="fa fa-close"></i> 返回</a>
                            </div>
                        </div>
...
<script >
    ...
    function initUploadSingle(){
        ratio = window.devicePixelRatio || 1,
         // 缩略图大小
        thumbnailWidth = 750 * ratio;
        thumbnailHeight = 750 * ratio;
                ...
                success: function(data) { // data 保存提交后返回的数据，一般为 json 数据
                    ...
                    if(data.status == 200){
                        ...
                        layer.msg(data.message,{icon: 6,time:2000,shade: 0.1},function(index){
                            window.location.href="${basePath}/image/text/list";
                        });
                    }else{
