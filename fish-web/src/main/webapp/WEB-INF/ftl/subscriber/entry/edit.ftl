...
<form class="form-horizontal m-t" id="myForm" action="${basePath}/subscriber/entry/edit" method="post" enctype="multipart/form-data">
                    ...
                    <div class="ibox-title">
                        <div class="builder-tabs builder-form-tabs">
                            <ul class="nav nav-tabs">
                                <li class="active"><a href="${basePath}/subscriber/entry/edit">编辑</a></li>
                            </ul>
                        </div>
                    </div>
                    <div class="ibox-content" style="border:none;">
                                    ...
                                    <div class="ibox-content">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-3">
                                                ...
                                                <input id="goodsName" value="${subscriber.name}" type="text" class="form-control" name="name" required="" placeholder="请输入姓名" aria-required="true">
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-3">
                                                ...
                                                <input id="describe" value="${subscriber.telephone}" type="text" class="form-control" name="telephone" required="" placeholder="请输入手机号" aria-required="true">
                                            </div>
                                        </div>
                        ...
                        <div class="form-group">
                            <div class="col-sm-8 col-sm-offset-3">
                                ...
                                <a  class="btn btn-danger" type="button"  href="${basePath}/subscriber/entry/list"><i class="fa fa-close"></i> 返回</a>
                            </div>
                        </div>
                ...
                success: function(data) { // data 保存提交后返回的数据，一般为 json 数据
                    ...
                    if(data.status == 200){
                        ...
                        layer.msg(data.message,{icon: 6,time:2000,shade: 0.1},function(index){
                            window.location.href="${basePath}/subscriber/entry/list";
                        });
                    }else{
