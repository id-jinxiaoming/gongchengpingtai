...
<form class="form-horizontal m-t" id="myForm" action="${basePath}/subscriber/entry/add" method="post" enctype="multipart/form-data">
                    ...
                    <div class="ibox-title">
                        <div class="builder-tabs builder-form-tabs">
                            <ul class="nav nav-tabs">
                                <li class="active"><a href="${basePath}/subscriber/entry/add">创建</a></li>
                            </ul>
                        </div>
                    </div>
                                    ...
                                    <div class="ibox-content">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-3">
                                                ...
                                                <input id="name" type="text" class="form-control" name="name" required="" placeholder="请输入姓名" aria-required="true">
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-4">
                                                ...
                                                <input id="telephone" type="text" class="form-control" name="telephone" required="" placeholder="请输入手机号" aria-required="true">
                                            </div>
                                        </div>
