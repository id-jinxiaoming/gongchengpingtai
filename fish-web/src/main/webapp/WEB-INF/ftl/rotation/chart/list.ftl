		                ...
		                {{# for(var i=0;i<d.length;i++){  }}
							<tr class="long-td">
                                ...
                                <td>
                                    ...
                                    {{# }else if(d[i].type==2){ }}
                                    <span style="background-color: #00ee00;color: #ffffff;border-radius: 5px;font-size: 20px;padding: 5px; ">微课堂</span>
                                    {{# }else { }}
                                    <span style="background-color: #B6D76F;color: #ffffff;border-radius: 5px;font-size: 20px;padding: 5px; ">内部公告</span>
                                    {{# } }}
                                </td>
