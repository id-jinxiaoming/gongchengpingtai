...
<form class="form-horizontal m-t" id="myForm" action="${basePath}/leading/cadre/edit" method="post" enctype="multipart/form-data">
                    ...
                    <div class="ibox-title">
                        <div class="builder-tabs builder-form-tabs">
                            <ul class="nav nav-tabs">
                                <li class="active"><a href="${basePath}/leading/cadre/edit">编辑</a></li>
                            </ul>
                        </div>
                    </div>
                    <div class="ibox-content" style="border:none;">
                                    ...
                                    <div class="ibox-content">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-3">
                                                ...
                                                <input id="goodsName" value="${leadingCadre.name}" type="text" class="form-control" name="name" required="" placeholder="请输入名称" aria-required="true">
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-3">
                                                ...
                                                <input id="describe" value="${leadingCadre.telephone}" type="text" class="form-control" name="telephone" required="" placeholder="请输入手机号" aria-required="true">
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-6">
                                                <div class="checkbox i-checks">
                                                    <label>
                                                        <input type="radio"
                                                                <#if leadingCadre.status=="1">
                                                                   checked=""
                                                                </#if>
                                                               name="type" value="1"> <i></i> 市场业务</label>
                                                    <label>
                                                        <input type="radio"
                                                                <#if leadingCadre.status=="2">
                                                                   checked=""
                                                                </#if>
                                                               name="type" value="2"> <i></i> 投标资审</label>
                                                    <label>
                                                        <input type="radio"
                                                                <#if leadingCadre.status=="3">
                                                                       checked=""
                                                                </#if>

                                                               name="type" value="3"> <i></i> 工程管理</label>
                                                    <label>
                                                        <input type="radio"
                                                                <#if leadingCadre.status=="4">
                                                                       checked=""
                                                                </#if>
                                                               name="type" value="4"> <i></i> 行政业务</label>
                                                    <label>
                                                        <input type="radio"
                                                                <#if leadingCadre.status=="5">
                                                                       checked=""
                                                                </#if>
                                                               name="type" value="5"> <i></i> 财务税务</label>
                                                    <label>
                                                        <input type="radio"
                                                                <#if leadingCadre.status=="6">
                                                                       checked=""
                                                                </#if>
                                                               name="type" value="6"> <i></i> 发票申请</label>
                        ...
                        <div class="form-group">
                            <div class="col-sm-8 col-sm-offset-3">
                                <input type="hidden" name="id" value=" ${leadingCadre.id}"/>
                                <button class="btn btn-primary" type="submit">提交</button>
                                <a  class="btn btn-danger" type="button"  href="${basePath}/leading/cadre/list"><i class="fa fa-close"></i> 返回</a>
                            </div>
                        </div>
                ...
                success: function(data) { // data 保存提交后返回的数据，一般为 json 数据
                    ...
                    if(data.status == 200){
                        ...
                        layer.msg(data.message,{icon: 6,time:2000,shade: 0.1},function(index){
                            window.location.href="${basePath}/leading/cadre/list";
                        });
                    }else{
