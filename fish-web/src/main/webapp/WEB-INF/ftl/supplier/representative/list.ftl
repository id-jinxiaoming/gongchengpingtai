        ...
        <div class="ibox-title">
            <div class="builder-tabs builder-form-tabs">
                <ul class="nav nav-tabs">
                    <li class="active"><a href="${basePath}/supplier/representative/list">列表展示</a></li>
                </ul>
            </div>
        </div>
        <div class="ibox-content" style="border-color: transparent">
            ...
            <div class="row">
                <div class="col-sm-12">
                    ...
                    <form id="myForm" name="admin_list_sea" class="form-search" method="post" action="${basePath}/supplier/representative/list">
                        <div class="col-sm-3" style="padding-right: 0px;padding-left: 0px;">
                            <div class="input-group">
                                <input type="text" id="key" class="form-control" name="key"  placeholder="输入公司名称" />
            ...
            <div class="example-wrap">
                <div class="example">
				<@shiro.hasPermission name="supplier:representative:add">
                    <button type="button" class="btn btn-outline btn-primary" onclick="add()">创建</button>
				</@shiro.hasPermission>

				<@shiro.hasPermission name="supplier:representative:delete">
                    ...
                    <table class="table table-bordered table-hover">
                        ...
                        <th style="text-align:center;">主营产品</th>
                        ...
                        <script id="datalist" type="text/html">
                            ...
                            <tr class="long-td">
                                ...
                                <td>{{d[i].mainProducts}}</td>
                                <td>
                                    <a href="javascript:;"  onclick="openImg('{{d[i].picture}}')">
                                        <img src="{{d[i].picture}}" style="width:80px;height:80px" onerror="this.src='${basePath}/static/webupload/empty_mid.png'"/>
                                    </a>
                                </td>
                                <td>
								<@shiro.hasPermission name="supplier:representative:edit">
                                    <a href="${basePath}/supplier/representative/edit/{{d[i].id}}"  class="btn btn-primary  btn-xs">
...
<script type="text/javascript">
    ...
    function Ajaxpage(curr){
        ...
        $.ajax({
            url: "${basePath}/supplier/representative/list",
    ...
    function add(){
        window.location.href="${basePath}/supplier/representative/add";

    }
    function edit(id){
        window.location.href="${basePath}/supplier/representative/edit/"+id;
    ...
    function DelAll(){
        ...
        layer.confirm('确认删除吗?', {icon: 3, title:'提示'}, function(index){
            ...
            $.ajax({
                url: "${basePath}/supplier/representative/delete",
                data:"id="+checkArray,
                type: "POST",
                dataType:'json',
