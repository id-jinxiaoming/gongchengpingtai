...
<form class="form-horizontal m-t" id="myForm" action="${basePath}/performance/display/add" method="post" enctype="multipart/form-data">
                    ...
                    <div class="ibox-title">
                        <div class="builder-tabs builder-form-tabs">
                            <ul class="nav nav-tabs">
                                <li class="active"><a href="${basePath}/performance/display/add">创建</a></li>
                            </ul>
                        </div>
                    </div>
                                    ...
                                    <div class="ibox-content">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-4">
                                                ...
                                                <input id="describe" type="text" class="form-control" name="describe" required="" placeholder="请输入描述" aria-required="true">
                                            </div>
                                        </div>
                                        <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-6">
                                                <div class="checkbox i-checks">
                                                    <label>
                                                        <input type="radio" name="type" value="1"> <i></i> 酒店办公类</label>
                                                    <label>
                                                        <input type="radio" name="type" value="2"> <i></i> 学校医院类</label>
                                                    <label>
                                                        <input type="radio" name="type" value="3"> <i></i> 商贸住宅类</label>
                                                    <label>
                                                        <input type="radio" name="type" value="4"> <i></i> 展览展示类</label>
                                                    <label>
                                                        <input type="radio" name="type" value="5"> <i></i> 建筑幕墙类</label>
