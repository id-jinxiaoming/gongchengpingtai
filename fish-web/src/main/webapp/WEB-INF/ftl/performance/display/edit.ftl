...
<form class="form-horizontal m-t" id="myForm" action="${basePath}/performance/display/edit" method="post" enctype="multipart/form-data">
                    ...
                    <div class="ibox-title">
                        <div class="builder-tabs builder-form-tabs">
                            <ul class="nav nav-tabs">
                                <li class="active"><a href="${basePath}/performance/display/edit">编辑</a></li>
                            </ul>
                        </div>
                    </div>
                    <div class="ibox-content" style="border:none;">
                                    ...
                                    <div class="ibox-content">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-3">
                                                ...
                                                <input id="goodsName" value="${performanceDisplay.title}" type="text" class="form-control" name="title" required="" placeholder="请输入标题" aria-required="true">
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-9" >
                                                <div >
                                                    <!--用来存放item-->
                                                    <img id="imgPhoto1" src="${performanceDisplay.image}" width="150px" height="150px"/>
                                                    <input id="photo1"  value="${performanceDisplay.image}"  type="hidden" name="image" value=""/>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-3">
                                                ...
                                                <input id="describe" value="${performanceDisplay.describe}" type="text" class="form-control" name="describe" required="" placeholder="请输入描述" aria-required="true">
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-9" >
                                            <textarea id="editor_id" name="details" style="width:700px;height:300px;">
                                            ${performanceDisplay.details}
                                            </textarea>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-6">
                                                <div class="checkbox i-checks">
                                                    <label>
                                                        <input type="radio"
                                                                <#if performanceDisplay.type=="1">
                                                                   checked=""
                                                                </#if>
                                                               name="type" value="1"> <i></i> 酒店办公类</label>
                                                    <label>
                                                        <input type="radio"
                                                                <#if performanceDisplay.type=="2">
                                                                       checked=""
                                                                </#if>

                                                               name="type" value="2"> <i></i> 学校医院类</label>
                                                    <label>
                                                        <input type="radio"
                                                                <#if performanceDisplay.type=="3">
                                                                       checked=""
                                                                </#if>
                                                               name="type" value="3"> <i></i> 商贸住宅类</label>
                                                    <label>
                                                        <input type="radio"
                                                                <#if performanceDisplay.type=="4">
                                                                       checked=""
                                                                </#if>
                                                               name="type" value="4"> <i></i> 展览展示类</label>
                                                    <label>
                                                        <input type="radio"
                                                                <#if performanceDisplay.type=="5">
                                                                       checked=""
                                                                </#if>
                                                               name="type" value="5"> <i></i> 建筑幕墙类</label>
                        ...
                        <div class="form-group">
                            <div class="col-sm-8 col-sm-offset-3">
                                <input type="hidden" name="id" value=" ${performanceDisplay.id}"/>
                                <button class="btn btn-primary" type="submit">提交</button>
                                <a  class="btn btn-danger" type="button"  href="${basePath}/performance/display/list"><i class="fa fa-close"></i> 返回</a>
                            </div>
                        </div>
                ...
                success: function(data) { // data 保存提交后返回的数据，一般为 json 数据
                    ...
                    if(data.status == 200){
                        ...
                        layer.msg(data.message,{icon: 6,time:2000,shade: 0.1},function(index){
                            window.location.href="${basePath}/performance/display/list";
                        });
                    }else{
