...
<form class="form-horizontal m-t" id="myForm" action="${basePath}/content/details/edit" method="post" enctype="multipart/form-data">
                    ...
                    <div class="ibox-title">
                        <div class="builder-tabs builder-form-tabs">
                            <ul class="nav nav-tabs">
                                <li class="active"><a href="${basePath}/content/details/edit">编辑</a></li>
                            </ul>
                        </div>
                    </div>
                    <div class="ibox-content" style="border:none;">
                                    ...
                                    <div class="ibox-content">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-9" >
                                                <div >
                                                    <!--用来存放item-->
                                                    <img id="imgPhoto1" src="${contentDetails.image}" width="150px" height="150px"/>
                                                    <input id="photo1"  value="${contentDetails.image}"  type="hidden" name="image" value=""/>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-6">
                                                <div class="checkbox i-checks">
                                                    <label>
                                                        <input type="radio"
                                                                <#if contentDetails.type=="1">
                                                                   checked=""
                                                                </#if>
                                                               name="type" value="1"> <i></i> 新闻快讯</label>
                                                    <label>
                                                        <input type="radio"
                                                                <#if contentDetails.type=="2">
                                                                       checked=""
                                                                </#if>

                                                               name="type" value="2"> <i></i> 微课堂</label>
                                                    <label>
                                                        <input type="radio"
                                                                <#if contentDetails.type=="3">
                                                                       checked=""
                                                                </#if>
                                                               name="type" value="3"> <i></i> 内部公告</label>
                                                    <#--<label>
                                                        <input type="radio"
                                                                <#if contentDetails.type=="4">
                                                                       checked=""
                                                                </#if>
                                                               name="type" value="4"> <i></i> 管理办法</label>
                                                    <label>
                                                        <input type="radio"
                                                                <#if contentDetails.type=="5">
                                                                       checked=""
                                                                </#if>
                                                               name="type" value="5"> <i></i> 办公流程</label>-->
                        ...
                        <div class="form-group">
                            <div class="col-sm-8 col-sm-offset-3">
                                ...
                                <a  class="btn btn-danger" type="button"  href="${basePath}/content/details/list"><i class="fa fa-close"></i> 返回</a>
                            </div>
                        </div>
                ...
                success: function(data) { // data 保存提交后返回的数据，一般为 json 数据
                    ...
                    if(data.status == 200){
                        ...
                        layer.msg(data.message,{icon: 6,time:2000,shade: 0.1},function(index){
                            window.location.href="${basePath}/content/details/list";
                        });
                    }else{
