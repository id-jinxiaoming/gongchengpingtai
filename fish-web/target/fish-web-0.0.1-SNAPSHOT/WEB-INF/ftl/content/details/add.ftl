...
<form class="form-horizontal m-t" id="myForm" action="${basePath}/content/details/add" method="post" enctype="multipart/form-data">
                    ...
                    <div class="ibox-title">
                        <div class="builder-tabs builder-form-tabs">
                            <ul class="nav nav-tabs">
                                <li class="active"><a href="${basePath}/content/details/add">创建</a></li>
                            </ul>
                        </div>
                    </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-6">
                                                <div class="checkbox i-checks">
                                                    <label>
                                                        <input type="radio" name="type" value="1"> <i></i> 新闻快讯</label>
                                                    <label>
                                                        <input type="radio" name="type" value="2"> <i></i> 微课堂</label>
                                                    <label>
                                                        <input type="radio" name="type" value="3"> <i></i> 内部公告</label>
                                                    <#--<label>
                                                        <input type="radio" name="type" value="4"> <i></i> 管理办法</label>
                                                    <label>
                                                        <input type="radio" name="type" value="5"> <i></i> 办公流程</label>-->
