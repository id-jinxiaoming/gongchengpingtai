                    ...
                    <table class="table table-bordered table-hover">
                        ...
                        <script id="datalist" type="text/html">
                            ...
                            <tr class="long-td">
                                ...
                                <td>
                                    {{# if(d[i].type==1){ }}
                                    <span style="background-color: #22bb22;color: #ffffff;border-radius: 5px;font-size: 20px;padding: 5px; ">制度规范</span>

                                    {{# }else if(d[i].type==2){ }}
                                    <span style="background-color: #ff0000;color: #ffffff;border-radius: 5px;font-size: 20px;padding: 5px; ">办公流程</span>
                                    {{# } }}
                                </td>
                                <td>
                                    {{# if(d[i].classification==1){ }}
                                    <span style="background-color: #dd9222;color: #ffffff;border-radius: 5px;font-size: 20px;padding: 5px; ">市场拓展</span>

                                    {{# }else if(d[i].classification==2){ }}
                                    <span style="background-color: #1945de;color: #ffffff;border-radius: 5px;font-size: 20px;padding: 5px; ">投标资审</span>
                                    ...
                                    <span style="background-color: #EF5352;color: #ffffff;border-radius: 5px;font-size: 20px;padding: 5px; ">财务税务</span>
                                    {{# }else { }}
                                    <span style="background-color: #00bbee;color: #ffffff;border-radius: 5px;font-size: 20px;padding: 5px; ">人力行政</span>
                                    {{# } }}
                                </td>
