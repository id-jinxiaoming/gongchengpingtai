                                    ...
                                    <div class="ibox-content">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-9" >
                                                <div >
                                                    <!--用来存放item-->
                                                    <img id="imgPhoto1" src="${textManagement.image}" width="150px" height="150px"/>
                                                    <input id="photo1"  value="${textManagement.image}"  type="hidden" name="image" value=""/>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-6">
                                                <div class="checkbox i-checks">
                                                    <label>
                                                        <input type="radio"
                                                                <#if textManagement.type=="1">
                                                                   checked=""
                                                                </#if>
                                                               name="type" value="1"> <i></i> 制度规范</label>
                                                    <label>
                                                        <input type="radio"
                                                                <#if textManagement.type=="2">
                                                                       checked=""
                                                                </#if>

                                                               name="type" value="2"> <i></i> 办公流程</label>
                                                </div>
                                            </div>
                                        </div>
                                                ...
                                                <div class="checkbox i-checks">
                                                    <label>
                                                        <input type="radio"
                                                               ...
                                                               name="classification" value="1"> <i></i> 市场拓展</label>
                                                    <label>
                                                        <input type="radio"
                                                               ...
                                                               name="classification" value="2"> <i></i> 投标资审</label>
                                                    <label>
                                                        <input type="radio"
                                                                <#if textManagement.classification=="3">
                                                                       checked=""
                                                                </#if>
                                                               name="classification" value="3"> <i></i> 工程管理</label>
                                                    <label>
                                                        <input type="radio"
                                                                <#if textManagement.classification=="4">
                                                                       checked=""
                                                                </#if>
                                                               name="classification" value="4"> <i></i> 财务税务</label>
                                                    <label>
                                                        <input type="radio"
                                                                <#if textManagement.classification=="5">
                                                                       checked=""
                                                                </#if>
                                                               name="classification" value="5"> <i></i> 人力行政</label>
