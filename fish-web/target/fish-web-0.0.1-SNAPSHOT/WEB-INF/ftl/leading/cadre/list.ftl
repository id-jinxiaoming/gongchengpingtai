        ...
        <div class="ibox-title">
            <div class="builder-tabs builder-form-tabs">
                <ul class="nav nav-tabs">
                    <li class="active"><a href="${basePath}/leading/cadre/list">通知人列表</a></li>
                </ul>
            </div>
        </div>
        <div class="ibox-content" style="border-color: transparent">
            ...
            <div class="row">
                <div class="col-sm-12">
                    ...
                    <form id="myForm" name="admin_list_sea" class="form-search" method="post" action="${basePath}/leading/cadre/list">
                        <div class="col-sm-3" style="padding-right: 0px;padding-left: 0px;">
                            <div class="input-group">
                                <input type="text" id="key" class="form-control" name="key"  placeholder="输入名称" />
                        ...
                        <script id="datalist" type="text/html">
                            ...
                            <tr class="long-td">
                                ...
                                <td>
                                    ...
                                    <span style="background-color: #0c7ffb;color: #ffffff;border-radius: 5px;font-size: 20px;padding: 5px; ">投标资审</span>
                                    ...
                                    <span style="background-color: #8fb61f;color: #ffffff;border-radius: 5px;font-size: 20px;padding: 5px; ">财务税务</span>
                                    {{# }else { }}
                                    <span style="background-color: #00bbee;color: #ffffff;border-radius: 5px;font-size: 20px;padding: 5px; ">发票申请</span>
                                    {{# } }}
                                ...
                                <td>
								<@shiro.hasPermission name="leading:cadre:edit">
                                    <a href="${basePath}/leading/cadre/edit/{{d[i].id}}"  class="btn btn-primary  btn-xs">
...
<script type="text/javascript">
    ...
    function Ajaxpage(curr){
        ...
        $.ajax({
            url: "${basePath}/leading/cadre/list",
    ...
    function edit(id){
        window.location.href="${basePath}/leading/cadre/edit/"+id;
