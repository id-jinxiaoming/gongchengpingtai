...
<body class="gray-bg" >
<form class="form-horizontal m-t" id="myForm" action="${basePath}/supplier/representative/add" method="post" enctype="multipart/form-data">
                    ...
                    <div class="ibox-title">
                        <div class="builder-tabs builder-form-tabs">
                            <ul class="nav nav-tabs">
                                <li class="active"><a href="${basePath}/supplier/representative/add">创建</a></li>
                            </ul>
                        </div>
                    </div>
                                ...
                                <div class="layui-tab-item layui-show">
                                    ...
                                    <div class="ibox-content">
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-3">
                                                <input id="bandName" type="text" class="form-control" name="bandName" required="" placeholder="请输入品牌名称" aria-required="true">
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label class="col-sm-3 control-label">公司名称：</label>
                                            <div class="col-sm-3">
                                                <input id="companyName" type="text" class="form-control" name="companyName" required="" placeholder="请输入公司名称" aria-required="true">
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-4">
                                                <textarea name="mainProducts" class="form-control"></textarea>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-9" >
                                                <div>
                                                    ...
                                                    <input id="photo1"  type="hidden" name="picture" value=""/>
