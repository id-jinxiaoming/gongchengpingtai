...
<form class="form-horizontal m-t" id="myForm" action="${basePath}/jump/button/add" method="post" enctype="multipart/form-data">
                    ...
                    <div class="ibox-title">
                        <div class="builder-tabs builder-form-tabs">
                            <ul class="nav nav-tabs">
                                <li class="active"><a href="${basePath}/jump/button/add">创建</a></li>
                            </ul>
                        </div>
                    </div>
                                ...
                                <div class="layui-tab-item layui-show">
                                    ...
                                    <div class="ibox-content">
                                        ...
                                        <div class="form-group">
                                            <label class="col-sm-3 control-label">跳转按钮栏位：</label>
                                            <div class="col-sm-3">
                                                <select class="form-control m-b" name="jptId">
                                                    <option value="0">无栏位</option>
                                                    <#list brand as item>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-9" >
                                                    <div >
                                                        ...
                                                        <input id="photo1"  type="hidden" name="images" value=""/>
