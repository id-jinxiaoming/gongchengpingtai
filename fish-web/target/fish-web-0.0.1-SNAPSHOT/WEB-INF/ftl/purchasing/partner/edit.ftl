...
<form class="form-horizontal m-t" id="myForm" action="${basePath}/purchasing/partner/edit" method="post" enctype="multipart/form-data">
                    ...
                    <div class="ibox-title">
                        <div class="builder-tabs builder-form-tabs">
                            <ul class="nav nav-tabs">
                                <li class="active"><a href="${basePath}/purchasing/partner/edit">编辑</a></li>
                            </ul>
                        </div>
                    </div>
                    <div class="ibox-content" style="border:none;">
                                    ...
                                    <div class="ibox-content">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-3">
                                                ...
                                                <input id="businessName" value="${purchasingPartner.businessName}" type="text" class="form-control" name="businessName" required="" placeholder="请输入企业名称" aria-required="true">
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label class="col-sm-3 control-label">主营产品：</label>
                                            <div class="col-sm-4">
                                                <textarea name="companyProfile" class="form-control">${(purchasingPartner.companyProfile)!''}</textarea>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-9" >
                                                <div >
                                                    <!--用来存放item-->
                                                    <img id="imgPhoto1" src="${purchasingPartner.picture}" width="150px" height="150px"/>
                                                    <input id="photo1"  value="${purchasingPartner.picture}"  type="hidden" name="picture" value=""/>
                        ...
                        <div class="form-group">
                            <div class="col-sm-8 col-sm-offset-3">
                                <input type="hidden" name="id" value=" ${purchasingPartner.id}"/>
                                <button class="btn btn-primary" type="submit">提交</button>
                                <a  class="btn btn-danger" type="button"  href="${basePath}/purchasing/partner/list"><i class="fa fa-close"></i> 返回</a>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                success: function(data) { // data 保存提交后返回的数据，一般为 json 数据
                    ...
                    if(data.status == 200){
                        ...
                        layer.msg(data.message,{icon: 6,time:2000,shade: 0.1},function(index){
                            window.location.href="${basePath}/purchasing/partner/list";
                        });
                    }else{
