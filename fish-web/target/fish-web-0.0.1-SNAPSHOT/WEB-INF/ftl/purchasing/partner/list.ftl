        ...
        <div class="ibox-title">
            <div class="builder-tabs builder-form-tabs">
                <ul class="nav nav-tabs">
                    <li class="active"><a href="${basePath}/purchasing/partner/list">列表展示</a></li>
                </ul>
            </div>
        </div>
        <div class="ibox-content" style="border-color: transparent">
            ...
            <div class="row">
                <div class="col-sm-12">
                    ...
                    <form id="myForm" name="admin_list_sea" class="form-search" method="post" action="${basePath}/purchasing/partner/list">
            ...
            <div class="example-wrap">
                <div class="example">
				<@shiro.hasPermission name="purchasing:partner:add">
                    <button type="button" class="btn btn-outline btn-primary" onclick="add()">创建</button>
				</@shiro.hasPermission>

				<@shiro.hasPermission name="purchasing:partner:delete">
                    ...
                    <table class="table table-bordered table-hover">
                        ...
                        <th style="text-align:center;">公司简介</th>
                        ...
                        <script id="datalist" type="text/html">
                            ...
                            <tr class="long-td">
                                ...
                                <td>{{d[i].id}}</td>
                                <td>{{d[i].businessName}}</td>
                                <td>{{d[i].companyProfile}}</td>
                                <td>
                                ...
                                <td>
								<@shiro.hasPermission name="purchasing:partner:edit">
                                    <a href="${basePath}/purchasing/partner/edit/{{d[i].id}}"  class="btn btn-primary  btn-xs">
...
<script type="text/javascript">
    ...
    function Ajaxpage(curr){
        ...
        $.ajax({
            url: "${basePath}/purchasing/partner/list",
    ...
    function add(){
        window.location.href="${basePath}/purchasing/partner/add";
    }

    function edit(id){
        window.location.href="${basePath}/purchasing/partner/edit/"+id;
    }
    //删除所有记录
    function DelAll(){
        ...
        layer.confirm('确认删除吗?', {icon: 3, title:'提示'}, function(index){
            $.ajax({
                url: "${basePath}/purchasing/partner/delete",
                data:"id="+checkArray,
                type: "POST",
                dataType:'json',
