        ...
        <div class="ibox-title">
            <div class="builder-tabs builder-form-tabs">
                <ul class="nav nav-tabs">
                    <li class="active"><a href="${basePath}/subscriber/entry/list">白名单列表</a></li>
                </ul>
            </div>
        </div>
        <div class="ibox-content" style="border-color: transparent">
            ...
            <div class="row">
                <div class="col-sm-12">
                    ...
                    <form id="myForm" name="admin_list_sea" class="form-search" method="post" action="${basePath}/subscriber/entry/list">
            ...
            <div class="example-wrap">
                <div class="example">
				<@shiro.hasPermission name="subscriber:entry:add">
                    <button type="button" class="btn btn-outline btn-primary" onclick="add()">创建</button>
				</@shiro.hasPermission>

				<@shiro.hasPermission name="subscriber:entry:delete">
                    ...
                    <table class="table table-bordered table-hover">
                        ...
                        <script id="datalist" type="text/html">
                            ...
                            <tr class="long-td">
                                ...
                                <td>{{d[i].telephone}}</td>
                                <td>
								<@shiro.hasPermission name="subscriber:entry:edit">
                                    <a href="${basePath}/subscriber/entry/edit/{{d[i].id}}"  class="btn btn-primary  btn-xs">
...
<script type="text/javascript">
    ...
    function Ajaxpage(curr){
        ...
        $.ajax({
            url: "${basePath}/subscriber/entry/list",
    ...
    function add(){
        window.location.href="${basePath}/subscriber/entry/add";

    }
    function edit(id){
        window.location.href="${basePath}/subscriber/entry/edit/"+id;
    ...
    function DelAll(){
        ...
        layer.confirm('确认删除吗?', {icon: 3, title:'提示'}, function(index){
            ...
            $.ajax({
                url: "${basePath}/subscriber/entry/delete",
                data:"id="+checkArray,
                type: "POST",
                dataType:'json',
