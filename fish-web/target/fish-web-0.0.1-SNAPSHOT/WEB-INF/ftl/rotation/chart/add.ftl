                    ...
                    <form class="form-horizontal m-t" id="myForm" action="${basePath}/rotation/chart/add" method="post" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-9">
                                <div class="radio i-checks">
                                  <#--  <label>
                                        <input type="radio" checked=checked value="1" name="type"> <i></i>新闻快讯</label>-->
                                    <label>
                                        <input type="radio"  value="2" name="type"> <i></i>规范制度/办公流程</label>
                                    <label>
                                    <input type="radio"  value="3" name="type"> <i></i>艺成园内部公告</label>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-3">
                                <input id="linkId" type="text" value="0" class="form-control" name="linkId" required="" aria-required="true">请输入图文列表id
                            </div>
                        </div>
