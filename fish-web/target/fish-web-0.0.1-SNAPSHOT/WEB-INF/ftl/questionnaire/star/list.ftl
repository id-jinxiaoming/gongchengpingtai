        ...
        <div class="ibox-title">
            <div class="builder-tabs builder-form-tabs">
                <ul class="nav nav-tabs">
                    <li class="active"><a href="${basePath}/questionnaire/star/list">问卷星展示</a></li>
                </ul>
            </div>
        </div>
	    <div class="ibox-content" style="border-color: transparent">
	        ...
	        <div class="row">
	            <div class="col-sm-12">  
	                ...
	                <form id="myForm" name="admin_list_sea" class="form-search" method="post" action="${basePath}/questionnaire/star/list">
		            ...
		            <table class="table table-bordered table-hover">
		                ...
		                {{# for(var i=0;i<d.length;i++){  }}
							<tr class="long-td">
								...
								<@shiro.hasPermission name="questionnaire:star:edit">
                                    <a href="${basePath}/questionnaire/star/edit/{{d[i].id}}"  class="btn btn-primary btn-xs">
...
<div class="spiner-example">
	...
	function Ajaxpage(curr){
		...
		$.ajax({
			url: "${basePath}/questionnaire/star/list",
    ...
    function edit(id){
        window.location.href="${basePath}/questionnaire/star/edit/"+id;
